    ...
    <div className={styles.tooltipMap} id={cardData.id}>
      <div className={styles.tooltipMap__userInfo}>
        ...
        <div className={styles.tooltipMap__userInfoText}>
          <Text size='20' lineHeight='24px'>
            {cardData.owner.name}
          </Text>
          <Text size='16' lineHeight='19px'>
            {hideNumber(cardData.owner.phone)}
          </Text>
        </div>
      </div>
      <div className={styles.tooltipMap__about}>
        ...
        <p>
          <a className={styles.tooltipMap__textAboutLink} href='*'>
            читать
          </a>
        </p>
      </div>
      <div className={styles.tooltipMap__status}>
        <Text color={COLORS.get('color-primary')} size='24' lineHeight='29px'>
          {cardData.completedAppQuantity}
        </Text>
