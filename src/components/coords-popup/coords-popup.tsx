...
export const CoordsPopup = ({ pageX, pageY, onOverlayClick, children, ...rest }: TCoordsPopup) => {
  ...
  return (modalsContainer != null)
    ? createPortal(
        <>
          <div className={style.wrapper} ref={wrapperRef} style={{ left: pageX - width + tongueWidth, top: pageY + tongueHeight }} {...rest}>
